...
public class Oval extends ComponentBase {
	
	protected Oval(Point position, int width, int height, boolean addHandles) {
	...
	public void draw(Graphics g) {
		...
		g.drawOval((int)getPosition().getX(), (int)getPosition().getY(), getWidth(), getHeight());
		g.drawOval((int)getPosition().getX()-1, (int)getPosition().getY()-1, getWidth()+2, getHeight()+2);
